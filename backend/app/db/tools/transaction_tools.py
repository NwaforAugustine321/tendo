...
def get_transaction_tools(business_id: str) -> list:
    ...
    @tool
    async def fetch_transactions(limit: int = 10, transaction_type: str = "", status: str = "") -> str:
    ...
    @tool
    async def fetch_transactions_summary(transaction_type: str = "") -> str:
    ...
    @tool
    async def fetch_customers(query: str = "") -> str:
