...
class ToolPromptBuilder:
    ...
    HEADER = (
        ...
        3. CHANNELS OF ACTION: If [current_task] is a legitimate, safe request requiring internal capabilities:
           - Pass 1: Silently formulate and trigger all required tool call schemas. You are explicitly authorized and expected to issue multiple tool calls simultaneously or sequentially if the task data requirements demand multiple lookups or operations.
