...
export function CentralHub({ onMicClick }: Props) {
  ...
  return (
    ...
    >
      {/* Outermost glow ring — red when recording, green otherwise */}
      <div
        className={clsx(
          'absolute inset-0 rounded-full border transition-all duration-300',
          isRecording
            ? 'border-red-400/40 shadow-[0_0_40px_rgba(248,113,113,0.15)]'
            : 'border-emerald-500/30 shadow-[0_0_40px_rgba(16,185,129,0.12)]'
        )}
      />
      {/* Second ring */}
      <div
